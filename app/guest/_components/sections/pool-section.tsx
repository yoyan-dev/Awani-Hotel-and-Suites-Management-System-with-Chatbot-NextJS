      ...
      <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
        <div className="relative">
          ...
          <div className="absolute bottom-4 right-4 bg-white/80 backdrop-blur-md px-4 py-2 rounded-lg shadow">
            <p className="text-sm text-gray-700">Open daily • 6 AM – 10 PM</p>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            Unwind by our luxurious infinity pool overlooking the city skyline.
            Whether you want to take a refreshing dip, lounge under the sun, or
            enjoy cocktails by the water, our poolside is the perfect spot to
